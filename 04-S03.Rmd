...
Using the appropriate function, subset `ess9` so that it contains only the variables listed above and place it in a new object called `ess`.
...
`idno, cntry, imbgeco, imueclt, imwbcnt, vote, uempla, agea, eduyrs, gndr, region`
...
Explore `ess` using `glimpse()`. What dimensions does the object have? What do you think about the class of some of these variables; do you think any of these might require transformation?
