...
::: attention
**WARNING 1:** Before proceeding to the exercises, ensure that you work in a RStudio project and that you **write** and **save** your answers to the exercises in an R script.
...
Now use the appropriate function to confirm that the column names have been changed.
...
Add the `id` vector as a column to the `bsas_sample` data frame.
...
::: question
Where in the data frame was this new 'vector' added?
:::
