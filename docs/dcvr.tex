...
\urlstyle{same}
\hypersetup{
  pdftitle={SOST70023 Data Cleaning and Visualisation using R},
  pdfauthor={Ioana Macoveciuc},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{SOST70023 Data Cleaning and Visualisation using R}
\usepackage{etoolbox}
\makeatletter
...
\chapter*{How to use this document}\label{how-to-use-this-document}}
