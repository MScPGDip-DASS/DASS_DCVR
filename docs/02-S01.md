...
To access the SPSS data file, unzip folder and open the folders in the following sequence: *UKDA-8850-spss \> spss \> spss25*. Follow the same approach for accessing the STATA file.   
