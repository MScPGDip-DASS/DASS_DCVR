...
Before you begin, load the `.Rdata` file. In your environment you will note four separate data objects: us_a, us_b, us_c, and us_d. Each of these represents a *wave*. 
