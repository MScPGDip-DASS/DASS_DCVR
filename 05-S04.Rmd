...
The R Markdown file you create should produce the following document: <a href="files_attached/DCVR_S04_Practical2.pdf" download="DCVR_S04_Practical2">click here to view the file</a>. You can view the file in your browser. If you want to save a copy, right-click on your mouse or keypad and select *Save as*. 
